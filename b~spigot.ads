...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_spigot" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b74508d9#;
   pragma Export (C, u00001, "spigotB");
   ...
   u00052 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00052, "ada__strings__fixedB");
   u00053 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00053, "ada__strings__fixedS");
   ...
   u00056 : constant Version_32 := 16#98e13b0e#;
   ...
   u00061 : constant Version_32 := 16#2eb48a6d#;
   pragma Export (C, u00061, "ada__strings__searchB");
   u00062 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00062, "ada__strings__searchS");
   u00063 : constant Version_32 := 16#457fb2da#;
   pragma Export (C, u00063, "ada__strings__unboundedB");
   u00064 : constant Version_32 := 16#f39c7224#;
   pragma Export (C, u00064, "ada__strings__unboundedS");
   u00065 : constant Version_32 := 16#d398a95f#;
   pragma Export (C, u00065, "ada__tagsB");
   u00066 : constant Version_32 := 16#12a0afb8#;
   pragma Export (C, u00066, "ada__tagsS");
   u00067 : constant Version_32 := 16#796f31f1#;
   pragma Export (C, u00067, "system__htableB");
   u00068 : constant Version_32 := 16#8c99dc11#;
   pragma Export (C, u00068, "system__htableS");
   u00069 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00069, "system__string_hashB");
   u00070 : constant Version_32 := 16#2ec7b76f#;
   pragma Export (C, u00070, "system__string_hashS");
   u00071 : constant Version_32 := 16#afdbf393#;
   pragma Export (C, u00071, "system__val_lluB");
   u00072 : constant Version_32 := 16#462f440a#;
   ...
   u00077 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00077, "system__compare_array_unsigned_8B");
   u00078 : constant Version_32 := 16#a1581e76#;
   pragma Export (C, u00078, "system__compare_array_unsigned_8S");
   u00079 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00079, "system__address_operationsB");
   u00080 : constant Version_32 := 16#1b57d1c8#;
   pragma Export (C, u00080, "system__address_operationsS");
   u00081 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00081, "system__storage_pools__subpoolsB");
   u00082 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00082, "system__storage_pools__subpoolsS");
   u00083 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00083, "system__finalization_mastersB");
   u00084 : constant Version_32 := 16#53a75631#;
   ...
   u00086 : constant Version_32 := 16#fd821e10#;
   ...
   u00089 : constant Version_32 := 16#86c56e5a#;
   pragma Export (C, u00089, "ada__finalizationS");
   u00090 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00090, "ada__streamsB");
   u00091 : constant Version_32 := 16#67e31212#;
   pragma Export (C, u00091, "ada__streamsS");
   u00092 : constant Version_32 := 16#92d882c5#;
   ...
   u00094 : constant Version_32 := 16#47a91c6b#;
   pragma Export (C, u00094, "system__finalization_rootS");
   u00095 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00095, "system__storage_poolsB");
   u00096 : constant Version_32 := 16#2bb6f156#;
   pragma Export (C, u00096, "system__storage_poolsS");
   u00097 : constant Version_32 := 16#84042202#;
   ...
   u00099 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00099, "system__atomic_countersB");
   u00100 : constant Version_32 := 16#bc074276#;
   pragma Export (C, u00100, "system__atomic_countersS");
   u00101 : constant Version_32 := 16#039168f8#;
   pragma Export (C, u00101, "system__stream_attributesB");
   u00102 : constant Version_32 := 16#8bc30a4e#;
   pragma Export (C, u00102, "system__stream_attributesS");
   u00103 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00103, "ada__strings__unbounded__text_ioB");
   u00104 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00104, "ada__strings__unbounded__text_ioS");
   u00105 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00105, "ada__text_ioB");
   u00106 : constant Version_32 := 16#1ffab6e1#;
   ...
   u00109 : constant Version_32 := 16#4e0ce0a1#;
   ...
   u00112 : constant Version_32 := 16#0f8892f9#;
   pragma Export (C, u00112, "system__os_libB");
   u00113 : constant Version_32 := 16#d8e681fb#;
   pragma Export (C, u00113, "system__os_libS");
   u00114 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00114, "system__stringsB");
   u00115 : constant Version_32 := 16#684d436e#;
   pragma Export (C, u00115, "system__stringsS");
   u00116 : constant Version_32 := 16#f5c4f553#;
